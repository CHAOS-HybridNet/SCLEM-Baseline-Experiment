...
def montage_kpi(train_data_path):
    ...
    # # 合并两个列表
    # return kpi_origin
    df_kpi = pd.read_csv(train_data_path + 'test_kpi.csv')
    df_log = pd.read_csv(train_data_path + 'test_log.csv')
...
def main(publish_date, prometheus_address, service, sc_id, train_date,task_count, step, timeout, train_duration, detection_duration,predict_interval):
    ...
    for sc_info in all_sc_info:
        ...
        train_data_dir="/home/zhengtinghua/shenchao/aiops-scwarn/data_20241019/data_as_SCWarn/new_train" + '/' + service + '/' + '60001/'
        test_data_dir="/home/zhengtinghua/shenchao/aiops-scwarn/data_20241019/data_as_SCWarn/new_test"+ '/'+service + '/' + sc_id + '/'
        ...
        print(train_data)
        train_data=torch.nan_to_num(torch.tensor(test_data),nan=0.0)
        print("===============================================")
